...
double kp = 6808.5, /*38,*/ ki = 0.09, kd = 0.99; /*0.58;*/                   //These parameters need you to modify
...
const double PID_Original[6] = {48.5, 0.09, 0.99, 3.5, 0.1058, 0.0}; //Restoring default PID parameters
